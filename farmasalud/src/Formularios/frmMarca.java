...
public class frmMarca extends javax.swing.JFrame {
    ...
    Controlador objM=new Controlador();
    ...
    void Muestra(){
        DefaultTableModel dt = (DefaultTableModel)jtMarca.getModel();
        dt.setRowCount(0);
        
        for (Marca x: objM.LisMar()){
            Object v[]={x.getCodMarca(),x.getNomMarca()};
                    dt.addRow(v);
        }
    }   
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String nom_ma=txtNom.getText();
        String cod_ma=txtCod.getText();
        
        Marca m = new Marca(nom_ma,cod_ma);
        objM.AdicionMar(m);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        m.setCodMarca(txtCod.getText());
        m.setNomMarca(txtNom.getText());
    ...
    private void jtMarcaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtMarcaMouseClicked
       int fila=jtMarca.getSelectedRow();
        txtCod.setText(jtMarca.getValueAt(fila, 0).toString());
        txtNom.setText(jtMarca.getValueAt(fila, 1).toString());
